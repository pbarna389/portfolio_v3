...
export const About = () => {
	return (
		<section
			id="about"
			className="flex flex-col gap-8 justify-center items-center relative sm:justify-between pt-6 pb-6 pr-4 pl-4 sm:pt-8 sm:pb-8 sm:pl-6 sm:pr-6 border-2 border-white w-full"
		>
			<SectionHeader
				title={'About Me'}
