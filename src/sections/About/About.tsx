			...
			<div className="sm:flex sm:flex-row sm:gap-10 w-full">
				...
				<div className="relative basis-1/2 flex flex-col justify-center items-center gap-4 sm:flex sm:items-start sm:gap-4  p-4">
					...
					<Button
						...
						className="flex flex-row rounded-md justify-center items-center gap-2 bg-highlight pt-[calc(0.5rem-2px)] pr-[calc(1rem-4px)]	pb-[calc(0.5rem-2px)] pl-[calc(1rem-4px)] justify-self-start text-center text-[14px] sm:text-xl sm:self-center transition hover:brightness-125 hover:scale-105"
					>
						<Icon name="download" />
						Download CV
					</Button>
