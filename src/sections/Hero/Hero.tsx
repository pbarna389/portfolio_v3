...
export const Hero = () => {
	...
	return (
		<section
			ref={ref}
			className={`flex flex-col gap-1 relative sm:flex sm:flex-row sm:justify-between sm:gap-10 pt-6 pr-4 pl-4 sm:pt-8 sm:pb-8 sm:pl-6 sm:pr-6 transition duration-500 blur-2xl border-2 border-white ${inView && 'blur-none'}`}
		>
			<Title />
